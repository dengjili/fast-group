...
public class StringUtil {
	...
	/** 设置星号邮箱地址 */
	public static String setAsteriskForEmail(String email) {
	...
	/** 设置星号手机号码 */
	public static String setAsteriskForPhone(String Phone) {
	...
	public static String getBASE64(String s) {
		...
		byte[] bytes = encode.encode(s.getBytes(Charset.defaultCharset()));
		String res = encode.encodeToString(bytes);
	...
	public static String getFromBase64(String s) {
		...
		if (s != null) {
			...
			byte[] decodeBuffer = decode.decode(s);
			result = new String(decodeBuffer, Charset.defaultCharset());
		}
		return result;
	}
